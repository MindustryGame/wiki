# <img id="spr" src="../../../images/blast-drill-icon-large.png"></img> Airblast Drill 
...
| --- | --- |
|Drillables| |
|Base Drill Speed|4.8  items/second  |

|Optional Enhancements||
| --- | --- |
|Booster|![liquid-water](../../images/liquid-water.png) 6 /sec Water  |
