# <img id="spr" src="/wiki/images/block-trident-ship-pad-large.png"></img> Реконструктор корабля «Трезубец»

*"Обеспечивает превращение в тяжёлый бомбардировщик поддержки.
